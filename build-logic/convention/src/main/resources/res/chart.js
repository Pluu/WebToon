 ...
 */
    ...
    function Ve(t, e, i, s) {
        ...
        return null !== l && ((!ut(o) || o === i || (l = We(r, a, o, l, s),
        null !== l)) && Ae(Array.from(r), [""], n, o, (()=>function(t, e, i) {
    ...
    function qe(t, e="x") {
        ...
        !function(t, e, i) {
            ...
            for (let c = 0; c < s - 1; ++c)
                l = h,
                h = Ye(t, c + 1),
                l && h && (jt(e[c], 0, $e) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c],
                o = i[c + 1] / e[c],
    ...
    function Ge(t, e, i, s, n) {
        ...
        e.capBezierPoints && function(t, e) {
            ...
            s = t.length; i < s; ++i)
                ...
                r = i < s - 1 && we(t[i + 1], e),
                o && (n = t[i],
                a && (n.cp1x = Ke(n.cp1x, e.left, e.right),
                n.cp1y = Ke(n.cp1y, e.top, e.bottom)),
                r && (n.cp2x = Ke(n.cp2x, e.left, e.right),
    ...
    function fi(t, e) {
        ...
        s && !("" + s).match(ri) && (console.warn('Invalid font style specified: "' + s + '"'),
        s = "");
        const n = {
    ...
    function Xi(t, e, i, s) {
        ...
        for (const r of t) {
            ...
            if (r.horizontal) {
                ...
                t.fullSize ? Ui(t, n.left, a, i.outerWidth - n.right - n.left, o) : Ui(t, e.left + l.placed, a, s, o),
                l.start = a,
                l.placed += s,
                a = t.bottom
            } else {
                ...
                t.fullSize ? Ui(t, o, n.top, a, i.outerHeight - n.bottom - n.top) : Ui(t, o, e.top + l.placed, a, s),
                l.start = o,
                l.placed += s,
                o = t.right
            }
    ...
    function is(t, e, i) {
        const s = t.canvas
          , n = new MutationObserver((t=>{
            let e = !1;
            for (const i of t)
                e = e || es(i.addedNodes, s),
                e = e && !es(i.removedNodes, s);
            e && i()
        }
        ));
    ...
    function rs(t, i, s) {
        ...
        return r.observe(o),
        function(t, e) {
            ns.size || window.addEventListener("resize", as),
            ns.set(t, e)
        }(t, a),
        r
    }
    function ls(t, e, i) {
        ...
        "resize" === e && function(t) {
            ns.delete(t),
            ns.size || window.removeEventListener("resize", as)
        }(t)
    }
    function hs(t, i, s) {
        const n = t.canvas
    ...
    class bs {
        ...
        _createAnimations(t, e) {
            ...
            for (r = o.length - 1; r >= 0; --r) {
                ...
                d && d.duration ? (n[l] = c = new ps(d,t,l,h),
                s.push(c)) : t[l] = h
            }
            return s
        }
    ...
    class Os {
        ...
        updateRangeFromParsed(t, e, i, s) {
            ...
            s && a && (s.values = a,
            o = ys(s, n, this._cachedMeta.index)),
    ...
    function Rs(t, e) {
        ...
        if (o > 0) {
            ...
            for (Es(e, l, h, U(s) ? 0 : a - s, a),
            t = 0,
            i = o - 1; t < i; t++)
                Es(e, l, h, n[t], n[t + 1]);
            return Es(e, l, h, r, U(s) ? e.length : r + s),
            l
        }
        return Es(e, l, h),
        l
    ...
    class Ns extends As {
        ...
        update(t, e, i) {
            ...
            o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = Rs(this, this.ticks),
            this._labelSizes = null,
            this.afterAutoSkip()),
        ...
        fit() {
            ...
            if (o) {
                ...
                t.height = Bs(n) + o) : (t.height = this.maxHeight,
                t.width = Bs(n) + o),
        ...
        buildOrUpdateScales() {
            ...
            et(n, (e=>{
                const n = e.options
                  ...
                  , a = qs(o, n)
                  , r = Z(n.type, e.dtype);
                void 0 !== n.position && an(n.position, a) === an(e.dposition) || (n.position = e.dposition),
                s[o] = !0;
                let l = null;
    ...
    function kn(t, e, i, s) {
        ...
        (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[Sn(c, a, r, l)] = !0,
        n = h)),
        o[Sn(n, a, r, l)] = !0,
        t.borderSkipped = o
    }
    function Sn(t, e, i, s) {
        var n, o, a;
        return s ? (a = i,
        t = Pn(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = Pn(t, e, i),
        t
    }
    function Pn(t, e, i) {
    ...
    class Qn extends As {
        ...
        draw(t, e) {
            const i = this.options;
            this.skip || i.radius < .1 || !we(this, e, this.size(i) / 2) || (t.strokeStyle = i.borderColor,
    ...
    var Co = {
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < s; ++a)
                l = n[a],
                l && !1 !== l.fill && (l.fill = bo(n, a, i.propagate))
        },
        beforeDraw(t, e, i) {
    ...
    class Xo extends As {
        ...
        _drawColorBox(t, e, i, s, n) {
            ...
            if (n.usePointStyle) {
                ...
                t.lineWidth = q(o.borderWidth) ? Math.max(...Object.values(o.borderWidth)) : o.borderWidth || 1,
                t.strokeStyle = o.borderColor,
        ...
        drawFooter(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = $o(this, i.footerAlign, i),
    ...
    class Qo extends Ns {
        ...
        buildTicks() {
            ...
            const s = function(t, e) {
                ...
                w = p),
                m && b && n && Ht((a - o) / n, k / 1e3) ? (M = Math.round(Math.min((a - o) / k, h)),
                k = (a - o) / M,
                v = o,
                w = a) : x ? (v = m ? o : v,
                w = b ? a : w,
                M = l - 1,
                k = (w - v) / M) : (M = (w - v) / k,
                M = jt(M, Math.round(M), k / 1e3) ? Math.round(M) : Math.ceil(M));
                ...
                v < o && P++,
                jt(Math.round((v + P * k) * y) / y, o, Jo(o, _, t)) && P++) : v < o && P++); P < M; ++P)
                    i.push({
    ...
    class da extends Qo {
        ...
        drawBackground() {
            ...
            if (t) {
                ...
                i.save(),
                i.beginPath(),
                ca(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length),
                i.closePath(),
                i.fillStyle = t,
                i.fill(),
                i.restore()
    ...
    function pa(t, e) {
        ...
        null === a ? null : (n && (a = "week" !== n || !Nt(o) && !0 !== o ? i.startOf(a, n) : i.startOf(a, "isoWeek", o)),
        +a)
    }
    function ma(t, e, i, s) {
        const n = fa.length;
    ...
    class _a extends Ns {
        ...
        _generate() {
            ...
            d++)
                ba(h, c, f);
            return c !== i && "ticks" !== s.bounds && 1 !== d || ba(h, c, f),
    ...
    return gn.register(zn, wa, ro, Ko),
    gn.helpers = {
        ...Ci
    },
    gn._adapters = _n,
